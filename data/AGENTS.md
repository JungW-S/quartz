...
- `data/topic_polish_log.yml` stores revision counts for the `topic 수정` / `토픽수정` trigger. Update only the selected topic's count and history after a completed polish pass.
